...
def parse_opts():
    ...
    parser.add_argument('--affection', type=str, help='affection category')
    parser.add_argument('--loss', type=str, help='loss type')
    parser.add_argument('--root_dir', type=str, default='.', help='path to daisee dataset')
    parser.add_argument('--labels_dir', type=str, default='.', help='path to Labels csvs')
    parser.add_argument('--epochs', type=int, help='number of epochs')
    parser.add_argument('--it', type=str, help='trial number')
